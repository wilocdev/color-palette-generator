export function CardSignup() {
  return (
    <div className="col-span-2 h-60 flex flex-col justify-between gap-3 bg-background text-accent shadow-lg rounded-lg p-4">
      ...
      <div className="bg-primary text-background rounded-lg py-2 text-center text-sm font-medium">
        Sign up
      </div>
    </div>
  )
